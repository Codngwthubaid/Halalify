...
//                         ) : (
//                             albums.map((album) => (
//                                 <Link to={`/albums/${album._id}`} key={album._id} className="flex items-center gap-2 hover:bg-zinc-800 p-2 rounded-md">
//                                     <img src={album.imageUrl} alt={album.name} className="w-8 h-8 rounded-md" />
//                                     <span className="hidden md:block">{album.name}</span>
//                                 </Link>
//                             ))
//                         )}
//                     </div>
